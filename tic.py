...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.status_label.setGeometry(QtCore.QRect(64, 20, 411, 71))
        font = QtGui.QFont()
        ...
        self.Button.setGeometry(QtCore.QRect(60, 550, 431, 71))
        font = QtGui.QFont()
        font.setFamily("Sitka Small Semibold")
        font.setPointSize(16)
        self.Button.setFont(font)
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(59, 129, 431, 361))
